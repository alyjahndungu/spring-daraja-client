...
@Component
public class GenericPutApi {

    final RestClient restClient;

    public GenericPutApi(@Qualifier(value = "restClientInSecure") RestClient restClient) {
    ...
    public <T, R> T genericPutRequest(
            R requestBody,
            MultiValueMap<String, String> queryParams,
            MultiValueMap<String, String> headers,
            String url,
    ...
    public <R> ResponseEntity<Void> genericPutVoidRequest(
            R requestBody,
            MultiValueMap<String, String> queryParams,
            MultiValueMap<String, String> headers,
            String url
